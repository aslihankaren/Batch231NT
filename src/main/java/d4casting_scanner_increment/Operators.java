...
public class Operators {
     ...
     */
        int paraMiktari=25;
        int kisiSayisi =10;
        System.out.println(paraMiktari/kisiSayisi);  // 2.5 cikmaliydi java noltayi sildi

        double ucretMiktari = 25;
        int   ogrenciSayisi = 10;
        System.out.println(ucretMiktari/ogrenciSayisi);  // 2.5 cikti buyuklukten kasit daha fazla bilgi saklayabilmektir
