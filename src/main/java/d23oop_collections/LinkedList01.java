...
Collections, bu dezavantajları çözmek için tasarlanmıştır.*/
       ...
       /* ArrayList<String> list1= new ArrayList<>();
        ...
        //List<String> list4= new ArrayList<>(); HATA,interface'ler constructor tarafinda kullanilamazlar*/
...
/*
        ...
        //ektra bilgi -- kisa yolla eleman ekleme
        LinkedList<String> likedList= new LinkedList<>(Arrays.asList("eleman 1", "eleman 2", "eleman 3"));
        System.out.println(likedList );  //[eleman 1, eleman 2, eleman 3] ama bu tavsiye edilmez


        LinkedList<String> linkedList2 = new LinkedList<>(List.of("a", "b", "c"));  //boyut degistirilebilir
        linkedList2.add("aslihan");
        System.out.println(linkedList2);  //[a, b, c]


        List<String> immutableList= List.of("eleman 1", "eleman 2", "eleman 3"); //boyut degistirilemz
...
*/
        ...
        myList.add(1, "Zeynep");
        System.out.println("myList = " + myList); //myList = [Ali, Zeynep, Veli, Ayse, Fatma]

        //3- addFirst(E e): Listenin basina oge ekler
        myList.addFirst("Hasan");
        System.out.println("myList = " + myList);  //myList = [Hasan, Ali, Zeynep, Veli, Ayse, Fatma]

        //4- addLast(E e): Listenin sonuna bir öğe ekler.
        myList.addLast("Hüseyin");
        System.out.println("myList = " + myList);  //myList = [Hasan, Ali, Zeynep, Veli, Ayse, Fatma, Hüseyin]

        //5) remove(Object o): Belirtilen öğeyi listeden kaldırır ve boolean dondurur

        boolean m1 = myList.remove("Ali");
        System.out.println("myList = " + myList);  //myList = [Hasan, Zeynep, Veli, Ayse, Fatma, Hüseyin] ali gitmis
        ...
        myList.add("Yusuf");
        myList.add(3, "Yusuf");
        System.out.println(myList);  //[Hasan, Zeynep, Veli, Yusuf, Ayse, Fatma, Hüseyin, Yusuf]

        myList.removeFirstOccurrence("Yusuf");
        System.out.println(myList);  //[Hasan, Zeynep, Veli, Ayse, Fatma, Hüseyin, Yusuf]

        // -------------Extra bilgi
/*
        myList.removeAll(Collections.singleton("Yusuf"));
        System.out.println(myList);  //[Hasan, Zeynep, Veli, Ayse, Fatma, Hüseyin] yusuflar gitti*/
        ...
        System.out.println(myList);  //[Hasan, Zeynep, Veli, Ayse, Fatma, Hüseyin] yusuf gitti
        ...
        System.out.println(myList); // [Zeynep, Veli, Ayse, Fatma, Hüseyin]
        ...
        System.out.println(myList);  //[Veli, Ayse, Fatma, Hüseyin]
