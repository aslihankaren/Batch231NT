...
/*
    ...
    */
        ...
        //ArrayList<Integer> ages= new ArrayList<Integer>(); // java 6 ve oncesinde
        ArrayList<Integer> ages = new ArrayList<>(); // java 7 ve sonrasinda -type inference- tip cikarma
        ...
        System.out.println(ages);  //[9, 12, 15]

        ages.add(1,28);
        System.out.println(ages);    //[9, 28, 12, 15]
       ...
       Integer eleman= ages.get(3); //java Intigeri inte ecevirdi unboxing
       ...
       Integer a= ages.set(1,25);
        System.out.println(a); //burda 2 verdi diyorki ikiyi degistirdem
