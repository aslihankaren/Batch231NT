...
public class Queue01 {
    ...
    //Queue nasil olusturulur?
        ...
        depo.clear();
        System.out.println(depo); //once temizlik sonra yazdirma
        ...
        // System.out.println(depo.element());  hata firlatti
    ...
    // Bu işlemi uygulamak için bir Deque kullanabilirsiniz.
       ...
       // Deque<String> d2= new ArrayDeque<>(); de yazabilirdik
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d);  //[Mehmet, Mahmut, Ekrem, Oya, Tansu] insertion order likedlist ten dolayi
        ...
        System.out.println(d);  //[Mehmet, Mahmut, Ekrem, Oya, Tansu, Karen]
